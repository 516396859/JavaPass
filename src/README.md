...
bgImage: /assets/bg/pexels-victor-lavaud.jpg
bgImageStyle:
  background-attachment: fixed
heroText: Java Pass
tagline: 简洁至上，最简洁的八股文，主打快速记忆。适合有一定基础、校招二轮复习和社招快速拾起知识的童鞋，知识化繁为简，让你快速巩固打牢基础。
actions:
  - text: 使用指南 💡
    link: ./demo/
    type: primary
...
highlights: 
  - header: Why not JavaGuide ...
    description: 专为应对面试而生的 Java 知识整理库，以提高记忆效率为出发点，为节省时间而设计。化繁为简，触动理解！二轮复习，看不进去？80%的知识都懂了，那就试试JavaPass吧！看着关键词提示，考验自己能否Pass！
    ...
    highlights:
      - title: 简洁的答案
        icon: object-group
        details: 化繁为简，真实面试时间很紧张，你需要说重点，JavaPass提供一针见血的关键回答。
        link: ./javabase/

      - title: 记忆要诀
        icon: circle-half-stroke
        details: 理解是记忆的基础，以关键词为切入点，只需记住少量的关键词，快速巩固知识点。
        link: ./javabase/

      - title: 百题Pass
        icon: circle-half-stroke
        details: 就像背英语单词一样（某某斩），我们为你每一道Pass掉的题进行记录。
        link: ./javabase/
...
copyright: false
footer: 赣ICP备2023007682 | 使用 <a href="https://theme-hope.vuejs.press/zh/" target="_blank">VuePress Theme Hope</a> 主题 | MIT 协议, 版权所有 © 2023-present Mr.Hope  
---
<!-- 
